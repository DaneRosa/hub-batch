...
module.exports = (function() {
  function makeUpdateUrlMappingRequest(answersObj) {
  ...
  function putContentUpdates(pageData) {
    ...
    var options = {
      method: 'PUT',
      url: 'http://api.hubapi.com/url-mappings/v3/url-mappings/'+ pageId,
      qs: queryString,
  ...
  return {
    makeUpdateUrlMappingRequest: makeUpdateUrlMappingRequest,
  };
})();
