  ...
  getUserPreferences: function(callback) {
    var questions = [
      ...
      },
      {
        ...
        choices: ['GET JSON', 'Update Buffer JSON', 'Push Buffer Live', 'Update Hard Object JSON', 'Publish Action', 'Rollback Hard Object JSON', 'Create Posts or Pages', 'Create URL Mappings', 'Update URL Mappings', 'DELETE URL Mappings', 'DELETE Forms', 'psi' ] // , 'Push JSON'
      },
        // Begin GET Options
      ...
      { // If UPDATE, BUFFER, PUSHBUFFERLIVE or PUBLISH are selected
        ...
        when: answers => (answers.method === 'Update Hard Object JSON' || answers.method === 'Publish Action' || answers.method === 'Update Buffer JSON' || answers.method === 'Push Buffer Live' || answers.method === 'Create URL Mappings' || answers.method === 'Create Posts or Pages' || answers.method === 'DELETE URL Mappings' || answers.method === 'DELETE Forms' ||answers.method === 'Update URL Mappings' ) // || answers.method === 'Push JSON'
      },
