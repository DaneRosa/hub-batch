...
<<<<<<< HEAD
        choices: ['GET JSON', 'Update Buffer JSON', 'Push Buffer Live', 'Update Hard Object JSON', 'Publish Action', 'Rollback Hard Object JSON', 'Create Posts or Pages', 'Create URL Mappings', 'Update URL Mappings', 'DELETE URL Mappings', 'DELETE Forms', 'psi', 'RESTORE Files', 'RESTORE Forms', 'Delete Lists' ] // , 'Push JSON'
=======
        choices: ['GET JSON', 'Update Buffer JSON', 'Push Buffer Live', 'Update Hard Object JSON', 'Publish Action', 'Rollback Hard Object JSON', 'Create Posts or Pages', 'Create URL Mappings', 'Update URL Mappings', 'DELETE URL Mappings', 'DELETE Forms', 'psi', 'RESTORE Files' ] // , 'Push JSON'
...
<<<<<<< HEAD
        when: answers => (answers.method === 'Update Hard Object JSON' || answers.method === 'Publish Action' || answers.method === 'Update Buffer JSON' || answers.method === 'Push Buffer Live' || answers.method === 'Create URL Mappings' || answers.method === 'Create Posts or Pages' || answers.method === 'DELETE URL Mappings' || answers.method === 'DELETE Forms' ||answers.method === 'Update URL Mappings' || answers.method === 'RESTORE Forms' || answers.method === 'restore files', answers.method === 'DELETE Lists' ) // || answers.method === 'Push JSON'
=======
        when: answers => (answers.method === 'Update Hard Object JSON' || answers.method === 'Publish Action' || answers.method === 'Update Buffer JSON' || answers.method === 'Push Buffer Live' || answers.method === 'Create URL Mappings' || answers.method === 'Create Posts or Pages' || answers.method === 'DELETE URL Mappings' || answers.method === 'DELETE Forms' ||answers.method === 'Update URL Mappings' || answers.method === 'RESTORE Files' ) // || answers.method === 'Push JSON'
>>>>>>> 69b79bbdea6cbfae061ce0c1fc4d0aeede84ff55
      },
