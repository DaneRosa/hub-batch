  ...
  getUserPreferences: function(callback) {
    var questions = [
      ...
      { // If UPDATE, BUFFER, PUSHBUFFERLIVE or PUBLISH are selected
        ...
        when: answers => (answers.method === 'Update Hard Object JSON' || answers.method === 'Publish Action' || answers.method === 'Update Buffer JSON' || answers.method === 'Push Buffer Live' || answers.method === 'Create URL Mappings' || answers.method === 'Create Posts or Pages' || answers.method === 'DELETE URL Mappings' || answers.method === 'Update URL Mappings' ) // || answers.method === 'Push JSON'
      },
