// regex to pull out id from files api "id": \d+,
...
module.exports = (function() {
  function makeRestoreFormsRequest(answersObj) {
  ...
  function putContentUpdates(pageData) {
    ...
    var options = {
      method: 'POST',
      url: 'http://api.hubapi.com/contacts/v2/forms/'+ pageId  +'/undelete', 
      qs: queryString,
  ...
  return {
    makeRestoreFormsRequest: makeRestoreFormsRequest,
  };
})();